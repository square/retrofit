...
public final class RequestFactoryTest {
    ...
    public void onlyOneEncodingIsAllowedMultipartFirst() {
        ...
        try {
            ...
            assertThat(e).hasMessage("Only one encoding annotation is allowed.\n    for method Example.method");
        }
    }
    ...
    public void multipleParameterAnnotationsNotAllowed() throws Exception {
        ...
        try {
            ...
            assertThat(e).hasMessage("Multiple Retrofit annotations found, only one allowed. (parameter #1)\n    for method Example.method");
        }
    }
    ...
    public void twoMethodsFail() {
        ...
        try {
            ...
            assertThat(e.getMessage()).isIn("Only one HTTP method is allowed. Found: PATCH and POST.\n    for method Example.method", "Only one HTTP method is allowed. Found: POST and PATCH.\n    for method Example.method");
        }
    }
    ...
    public void lackingMethod() {
        ...
        try {
            ...
            assertThat(e).hasMessage("HTTP method annotation is required (e.g., @GET, @POST, etc.).\n    for method Example.method");
        }
    }
    ...
    public void implicitMultipartForbidden() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@Part parameters can only be used with multipart encoding. (parameter #1)\n    for method Example.method");
        }
    }
    ...
    public void implicitMultipartWithPartMapForbidden() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@PartMap parameters can only be used with multipart encoding. (parameter #1)\n    for method Example.method");
        }
    }
    ...
    public void multipartFailsOnNonBodyMethod() {
        ...
        try {
            ...
            assertThat(e).hasMessage("Multipart can only be specified on HTTP methods with request body (e.g., @POST).\n    for method Example.method");
        }
    }
    ...
    public void multipartFailsWithNoParts() {
        ...
        try {
            ...
            assertThat(e).hasMessage("Multipart method must contain at least one @Part.\n    for method Example.method");
        }
    }
    ...
    public void implicitFormEncodingByFieldForbidden() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@Field parameters can only be used with form encoding. (parameter #1)\n    for method Example.method");
        }
    }
    ...
    public void implicitFormEncodingByFieldMapForbidden() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@FieldMap parameters can only be used with form encoding. (parameter #1)\n    for method Example.method");
        }
    }
    ...
    public void headersFailWhenMalformed() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@Headers value must be in the form \"Name: Value\". Found: \"Malformed\"\n    for method Example.method");
        }
    }
    ...
    public void pathParamNonPathParamAndTypedBytes() {
        ...
        try {
            ...
            assertThat(e).hasMessage("URL \"/{a}\" does not contain \"{b}\". (parameter #2)\n    for method Example.method");
        }
    }
    ...
    public void nonBodyHttpMethodWithSingleEntity() {
        ...
        try {
            ...
            assertThat(e).hasMessage("Non-body HTTP method cannot contain @Body.\n    for method Example.method");
        }
    }
    ...
    public void queryMapRejectsNull() {
        class Example {
            ...
            Call<ResponseBody> method(@QueryMap Map<String, String> a) {
                return getNullValue(a);
            }

            Call<ResponseBody> getNullValue(@QueryMap Map<String, String> a) {
                return null;
            }
        }
        try {
    ...
    public void headerMapMustBeAMapOrHeaders() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@HeaderMap parameter type must be Map or Headers. (parameter #2)\n    for method Example.method");
        }
    }
    ...
    public void headerMapRejectsNull() {
        class Example {
            ...
            Call<ResponseBody> method(@HeaderMap Map<String, String> headers) {
                return getNullPointer(headers);
            }

            Call<ResponseBody> getNullPointer(@HeaderMap Map<String, String> headers) {
                return null;
            }
        }
        try {
    ...
    public void getWithHeaders() {
        ...
        okhttp3.Headers headers = new okhttp3.Headers.Builder().add("Accept", "text/plain").add("Accept", "application/json").add("Accept-Charset", "utf-8").build();
        Request request = buildRequest(Example.class, headers);
        assertThat(request.method()).isEqualTo("GET");
        assertThat(request.url().toString()).isEqualTo("http://example.com/search");
        assertThat(request.body()).isNull();
    ...
    public void getWithHeadersAndHeaderMap() {
        class Example {
            ...
            @GET("/search")
            Call<ResponseBody> method(@HeaderMap okhttp3.Headers headers, @HeaderMap Map<String, Object> headerMap) {
                throw new AssertionError();
            }
        }
        okhttp3.Headers headers = new okhttp3.Headers.Builder().add("Accept", "text/plain").add("Accept-Charset", "utf-8").build();
    ...
    public void getWithHeaderMapAllowingUnsafeNonAsciiValues() {
        class Example {
            ...
            @GET("/search")
            Call<ResponseBody> method(@HeaderMap(allowUnsafeNonAsciiValues = true) Map<String, Object> headers) {
                return null;
            }
        }
        Map<String, Object> headers = new LinkedHashMap<>();
    ...
    public void twoBodies() {
        ...
        try {
            ...
            assertThat(e).hasMessage("Multiple @Body method annotations found. (parameter #2)\n    for method Example.method");
        }
    }
    ...
    public void bodyInNonBodyRequest() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@Body parameters cannot be used with form or multi-part encoding. (parameter #2)\n    for method Example.method");
        }
    }
    ...
    public void headWithoutVoidThrows() {
        ...
        try {
            ...
            assertThat(e).hasMessage("HEAD method must use Void or Unit as response type.\n    for method Example.method");
        }
    }
    ...
    public void post() {
        class Example {
            ...
            @POST("/foo/bar/")
            Call<ResponseBody> method(@Body RequestBody body) {
                return emptyMethod(body);
            }

            Call<ResponseBody> emptyMethod(@Body RequestBody body) {
                return null;
            }
        }
        RequestBody body = RequestBody.create(TEXT_PLAIN, "hi");
    ...
    public void getWithPathParam() {
        class Example {
            ...
            Call<ResponseBody> method(@Path("ping") String ping) {
                return getOptionList(ping);
            }

            Call<ResponseBody> getOptionList(@Path("ping") String ping) {
                return null;
            }
        }
    ...
    public void getWithEncodedPathParam() {
        class Example {
            ...
            Call<ResponseBody> method(@Path(value = "ping", encoded = true) String ping) {
                return generateNullValue(ping);
            }

            Call<ResponseBody> generateNullValue(@Path(value = "ping", encoded = true) String ping) {
                return null;
            }
        }
    ...
    public void pathParametersAndPathTraversal() {
        ...
        assertThat(buildRequest(Example.class, "a/..").url().encodedPath()).isEqualTo("/foo/bar/a%2F../");
        assertThat(buildRequest(Example.class, "../a").url().encodedPath()).isEqualTo("/foo/bar/..%2Fa/");
        assertThat(buildRequest(Example.class, "..\\..").url().encodedPath()).isEqualTo("/foo/bar/..%5C../");
        assertThat(buildRequest(Example.class, "%2E").url().encodedPath()).isEqualTo("/foo/bar/%252E/");
        assertThat(buildRequest(Example.class, "%2E%2E").url().encodedPath()).isEqualTo("/foo/bar/%252E%252E/");
    }
    ...
    public void getWithQueryParam() {
        class Example {
            ...
            Call<ResponseBody> method(@Query("ping") String ping) {
                return methodOne(ping);
            }

            Call<ResponseBody> methodOne(@Query("ping") String ping) {
                return null;
            }
        }
        Request request = buildRequest(Example.class, "pong");
    ...
    public void getWithPathAndQueryQuestionMarkParam() {
        class Example {
            ...
            Call<ResponseBody> method(@Path("ping") String ping, @Query("kit") String kit) {
                return setReturnValue(ping, kit);
            }

            Call<ResponseBody> setReturnValue(@Path("ping") String ping, @Query("kit") String kit) {
                return null;
            }
        }
    ...
    public void getWithQueryNameParam() {
        class Example {
            ...
            Call<ResponseBody> generate(@QueryName String ping) {
                return null;
            }
        }
        Request request = buildRequest(Example.class, "pong");
    ...
    public void getWithStringUrl() {
        class Example {
            ...
            Call<ResponseBody> method(@Url String url) {
                return generateNames(url);
            }

            Call<ResponseBody> generateNames(@Url String url) {
                return null;
            }
        }
    ...
    public void getWithHttpUrl() {
        class Example {
            ...
            Call<ResponseBody> method(@Url HttpUrl url) {
                return generateNullObject(url);
            }

            Call<ResponseBody> generateNullObject(@Url HttpUrl url) {
                return null;
            }
        }
    ...
    public void getWithNonStringUrlThrows() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@Url must be okhttp3.HttpUrl, String, java.net.URI, or android.net.Uri type." + " (parameter #1)\n" + "    for method Example.method");
        }
    }
    ...
    public void multipartRequiresName() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@Part annotation must supply a name or use MultipartBody.Part parameter type. (parameter #1)\n" + "    for method Example.method");
        }
    }
    ...
    public void multipartOkHttpPartForbidsName() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@Part parameters using the MultipartBody.Part must not include a part name in the annotation. (parameter #1)\n" + "    for method Example.method");
        }
    }
    ...
    public void multipartOkHttpPart() throws IOException {
        class Example {
            ...
            Call<ResponseBody> method(@Part MultipartBody.Part part) {
                return getDefaultReturnValue(part);
            }

            Call<ResponseBody> getDefaultReturnValue(@Part MultipartBody.Part part) {
                return null;
            }
        }
    ...
    public void multipartPartMap() throws IOException {
        class Example {
            ...
            Call<ResponseBody> method(@PartMap Map<String, RequestBody> parts) {
                return generateNamesWithNullReturnType(parts);
            }

            Call<ResponseBody> generateNamesWithNullReturnType(@PartMap Map<String, RequestBody> parts) {
                return null;
            }
        }
    ...
    public void multipartPartMapRejectsNonStringKeys() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@PartMap keys must be of type String: class java.lang.Object (parameter #1)\n" + "    for method Example.method");
        }
    }
    ...
    public void multipartPartMapRejectsOkHttpPartValues() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@PartMap values cannot be MultipartBody.Part. Use @Part List<Part> or a different value type instead. (parameter #1)\n" + "    for method Example.method");
        }
    }
    ...
    public void multipartPartMapMustBeMap() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@PartMap parameter type must be Map. (parameter #1)\n    for method Example.method");
        }
    }
    ...
    public void fieldMapRejectsNull() {
        class Example {
            ...
            Call<ResponseBody> setToNull(@FieldMap Map<String, Object> a) {
                return null;
            }
        }
        try {
    ...
    public void fieldMapMustBeAMap() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@FieldMap parameter type must be Map. (parameter #1)\n    for method Example.method");
        }
    }
    ...
    public void simpleHeadersAllowingUnsafeNonAsciiValues() {
        class Example {
            ...
            @GET("/foo/bar/")
            @Headers(value = { "ping: pong", "title: Kein plötzliches" }, allowUnsafeNonAsciiValues = true)
            Call<ResponseBody> method() {
                return null;
            }
        }
    ...
    public void headersDoNotOverwriteEachOther() {
        class Example {
            ...
            @GET("/foo/bar/")
            @Headers({ "ping: pong", "kit: kat", "kit: -kat" })
            Call<ResponseBody> method() {
                return null;
            }
        }
    ...
    public void headerParamAllowingUnsafeNonAsciiValues() {
        class Example {
            ...
            //
            @Headers("ping: pong")
            Call<ResponseBody> method(@Header(value = "title", allowUnsafeNonAsciiValues = true) String kit) {
                return null;
            }
        }
    ...
    public void contentTypeParameterHeaderOverrides() {
        class Example {
            ...
            Call<ResponseBody> method(@Header("Content-Type") String contentType, @Body RequestBody body) {
                return none(contentType, body);
            }

            Call<ResponseBody> none(@Header("Content-Type") String contentType, @Body RequestBody body) {
                return null;
            }
        }
    ...
    public void malformedAnnotationRelativeUrlThrows() {
        ...
        try {
            ...
            assertThat(e).hasMessage("Malformed URL. Base: http://example.com/, Relative: ftp://example.org");
        }
    }
    ...
    public void tagDuplicateFails() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@Tag type java.lang.String is duplicate of parameter #1 and would always overwrite its value. (parameter #2)\n" + "    for method Example.method");
        }
    }
    ...
    public void tagGenericDuplicateFails() {
        ...
        try {
            ...
            assertThat(e).hasMessage("@Tag type java.util.List is duplicate of parameter #1 and would always overwrite its value. (parameter #2)\n" + "    for method Example.method");
        }
    }

...
public final class ObservableThrowingSafeSubscriberTest {
    ...
    public void bodyThrowingInOnErrorDeliveredToPlugin() {
        ...
        RxJavaPlugins.getInstance().registerErrorHandler(new RxJavaErrorHandler() {
            ...
            @Override
            public void handleError(Throwable throwable) {
                checkOnErrorFailedException(throwable);
            }
        });
        RecordingSubscriber<String> observer = subscriberRule.create();
    ...
    public void checkAndThrow(Throwable throwable) {
    ...
    public void checkOnErrorFailedException(Throwable throwable) {
        if (throwable instanceof OnErrorFailedException && !pluginRef.compareAndSet(null, throwable)) {
            // Don't swallow secondary errors!
            throw Exceptions.propagate(throwable);
        }
    }
    ...
    public void setOrThrowPropagate(Throwable throwable) {

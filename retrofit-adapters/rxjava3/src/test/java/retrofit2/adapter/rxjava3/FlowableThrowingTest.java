...
public final class FlowableThrowingTest {
    ...
    @Before
    public void setUp() {
        Retrofit retrofit = new Retrofit.Builder().baseUrl(server.url("/")).addConverterFactory(new StringConverterFactory()).addCallAdapterFactory(RxJava3CallAdapterFactory.createSynchronous()).build();
    ...
    public void setOrPropagateError(Throwable throwable) {
